		...
		<div id="container7">
			<div class="container">
				<div class="spinBtn">Spin</div>
					<div class="wheel">
						<div class="number" style="--i:1;--clr:#db7093;"><span>${Rest1}</span></div>
						<div class="number" style="--i:2;--clr:#20b2aa;"><span>${Rest2}</span></div>
						<div class="number" style="--i:3;--clr:#daa520;"><span>${Rest3}</span></div>
						<div class="number" style="--i:4;--clr:#ff340f;"><span>${Rest4}</span></div>
						<div class="number" style="--i:5;--clr:#4169e1;"><span>${Rest5}</span></div>
						<div class="number" style="--i:6;--clr:#3cb371;"><span>${Rest6}</span></div>
