        ...
        <div id="container4">
          <div class="options">
            ...
            <br><b><label style="position: relative;bottom:30px;">預算</label></b>
              <label><input type="checkbox" name="預算1" value="50-100" ><span>100元以下</span></label>
              <label><input type="checkbox" name="預算2" value="100-150"><span>100-150元</span></label>
              <label><input type="checkbox" name="預算3" value="150-200"> <span>150-200元</span>  </label>
              <label><input type="checkbox" name="預算4" value="200-250"><span>200-250元</span></label>
              <label><input type="checkbox" name="預算5" value="250-300"><span>250元以上</span></label>
              <label><input type="checkbox" name="預算6" class="checkAll"><span>不限</span></label>
        
           
            <div class="tab"></div> 
            <br><b><label style="position: relative;bottom:30px;">用餐時間</label></b>
              <label><input type="checkbox" name="用餐時間1" value="10min-30min"><span>30分以下</span></label>
              <label><input type="checkbox" name="用餐時間2" value="30min-1hr"><span>30分-1小時</span></label>
              <label><input type="checkbox" name="用餐時間3" value="1hr以上"><span>1小時以上</span></label>
              <label><input type="checkbox" name="用餐時間4" class="checkAll"><span>不限</span></label>
            ...
            <br><b><label style="position: relative;bottom:30px;">口味</label></b>
              ...
              <label><input type="checkbox" name="口味4" class="checkAll"><span>不限</span></label>
            ...
            <br><b><label style="position: relative;bottom:30px;">距離何處較近</label></b>
              ...
              <label><input type="checkbox" name="位置4" class="checkAll"><span>不限</span></label>
